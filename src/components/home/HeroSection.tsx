...
const HeroSection: React.FC = () => {
  return (
    <section className="mt-16 hero-gradient overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 py-20 md:py-32 grid grid-cols-1 md:grid-cols-2 gap-8 items-center relative z-10">
        ...
        >
          ...
          <motion.div 
            className="absolute top-6 -left-4 bg-accent rounded-lg shadow-lg p-3 rotate-6"
            animate={{ y: [0, 10, 0] }}
          ...
          <motion.div 
            className="absolute bottom-6 -right-4 bg-primary/10 rounded-lg shadow-lg p-3 -rotate-6"
            animate={{ y: [0, -15, 0] }}
