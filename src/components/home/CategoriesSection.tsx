...
const CategoriesSection: React.FC = () => {
  ...
  if (loading) {
    return <section className="relative py-24 overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-br from-purple-400/20 to-pink-400/20 rounded-full blur-3xl animate-pulse" style={{
          animationDelay: '1s'
        }} />
        </div>
  ...
  return <section className="relative py-32 overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/40 to-purple-50/30">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-10 w-[400px] h-[400px] bg-gradient-to-br from-purple-400/20 via-pink-400/15 to-orange-400/10 rounded-full blur-3xl animate-pulse" style={{
        animationDelay: '2s'
      }} />
        ...
        <div className="absolute bottom-32 left-32 w-16 h-16 bg-gradient-to-br from-purple-500/20 to-pink-500/10 rounded-full animate-float" style={{
        animationDelay: '1.5s'
      }} />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        duration: 0.8
          ...
          {/* Main Title */}
          <motion.h2 className="text-6xl font-bold mb-6 leading-tight" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
          ...
          delay: 0.3
            ...
            <span className="bg-gradient-to-r from-primary via-blue-600 to-purple-600 bg-clip-text text-transparent"> الفئة</span>
          </motion.h2>
          
          {/* Subtitle */}
          <motion.p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-medium" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
        ...
        <motion.div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 mb-20" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{
        once: true,
        amount: 0.2
      }}>
          {categories.map((category, index) => <motion.div key={category.id} variants={cardVariants} whileHover={{
          y: -12,
          scale: 1.02
        ...
        {/* Modern CTA Button */}
        {categories.length > 0 && <motion.div className="text-center" initial={{
        opacity: 0,
        y: 30
      }} whileInView={{
        opacity: 1,
