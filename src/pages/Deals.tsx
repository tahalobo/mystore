...
import { FlameIcon, Zap, Tag, Clock, Gift, Ban, CheckCircle, Sparkles, ChevronRight, Percent } from "lucide-react";
      ...
      <main className="flex-grow pt-24">
        ...
        <section className="bg-gradient-to-r from-purple-50 to-indigo-50 py-12 md:py-16">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center text-center">
              <motion.h1 className="text-4xl md:text-5xl font-bold mb-4" initial={{
              opacity: 0,
              y: -20
            }} animate={{
              opacity: 1,
              ...
              <motion.p className="text-lg text-gray-600 max-w-2xl mb-8" initial={{
              opacity: 0
            }} animate={{
              opacity: 1
            }} transition={{
              ...
              <motion.div className="flex flex-wrap gap-4 justify-center items-center" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
        ...
        <section className="py-8 bg-gradient-to-r from-red-500 to-orange-500 text-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <Button variant="secondary" size="sm" className="bg-white text-red-500 hover:bg-white/90" onClick={() => setCurrentTab("flash-sale")}>
                تسوق عروض الفلاش
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            <Tabs defaultValue="all-deals" value={currentTab} onValueChange={setCurrentTab} className="w-full">
              ...
              <motion.div variants={containerVariants} initial="hidden" animate="visible" key={currentTab}>
                {isLoading ? <div className="flex justify-center items-center min-h-[400px]">
                    <div className="w-12 h-12 border-4 border-primary/30 border-t-primary rounded-full animate-spin"></div>
                  </div> : productsToShow().length > 0 ? <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {productsToShow().map(product => <motion.div key={product.id} variants={itemVariants} className="h-full">
                        <ProductCard product={product} onProductClick={handleProductClick} className="h-full" />
                      </motion.div>)}
        ...
        <section className="py-12 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            }].map((category, index) => <motion.div key={category.name} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow" whileHover={{
              y: -5
            }} initial={{
              opacity: 0,
              y: 20
              ...
              delay: index * 0.1
                  ...
                  <Button variant="ghost" className="w-full h-full py-6 flex flex-col items-center justify-center gap-2" asChild>
