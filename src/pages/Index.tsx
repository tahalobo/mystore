...
const Index: React.FC = () => {
  ...
  return <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        <motion.section className="section-padding bg-gray-50 py-16" initial="hidden" whileInView="visible" viewport={{
        once: true,
        amount: 0.2
      }} variants={sectionVariants}>
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
              <div>
                <motion.h2 className="text-3xl font-bold" initial={{
                opacity: 0,
                x: -20
              }} whileInView={{
                opacity: 1,
                ...
                <motion.p className="text-gray-600 mt-2" initial={{
                opacity: 0,
                x: -20
              }} whileInView={{
                opacity: 1,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {bestSellers.map((product, index) => <motion.div key={product.id} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
