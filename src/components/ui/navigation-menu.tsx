  ...
  return (
    <NavigationMenuPrimitive.List
      ...
      className={cn(
        ...
        isRTL ? "space-x-reverse" : "space-x-1",
        className
      )}
      {...props}
    />
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        "top-0 w-full data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out",
        isRTL 
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div className={cn("absolute top-full flex justify-center", isRTL ? "right-0" : "left-0")}>
