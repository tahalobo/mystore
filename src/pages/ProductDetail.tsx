        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          duration: 0.5
            ...
            <div className="grid grid-cols-4 gap-2">
              {productImages.map((img, index) => <div key={index} onClick={() => setSelectedImage(index)} className={`cursor-pointer aspect-square rounded-md overflow-hidden border-2 ${selectedImage === index ? 'border-primary' : 'border-transparent'}`}>
          ...
          delay: 0.2
            ...
            <div>
              <div className="flex items-center">
                ...
                {product.bestSeller && <Badge className="ml-2 mb-2 bg-amber-500 hover:bg-amber-600">الأكثر مبيعاً</Badge>}
              </div>
              ...
              <div className="flex items-center mb-2">
                <div className="flex mr-2">
                  {[...Array(5)].map((_, i) => <Star key={i} className={`h-4 w-4 ${i < product.rating ? 'text-amber-400 fill-amber-400' : 'text-gray-300'}`} />)}
                </div>
            ...
            {product.stock > 0 ? <div className="text-green-600 flex items-center">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center border rounded-md">
                <button className="px-3 py-2 text-gray-600" onClick={() => handleQuantityChange(-1)} disabled={quantity <= 1}>
                  <Minus className="h-4 w-4" />
                </button>
                <span className="px-4 py-2 font-medium">{quantity}</span>
                <button className="px-3 py-2 text-gray-600" onClick={() => handleQuantityChange(1)} disabled={quantity >= product.stock}>
          ...
          <Tabs defaultValue="details">
            ...
            <TabsContent value="details" className="p-6 bg-white rounded-b-lg shadow-sm">
              <div className="space-y-4">
                ...
                <div className="mt-6">
                  <button onClick={() => setIsSpecsOpen(!isSpecsOpen)} className="flex items-center text-primary font-medium">
                    عرض المزيد من المواصفات
                    <ChevronDown className={`ml-1 h-5 w-5 transform transition-transform ${isSpecsOpen ? 'rotate-180' : ''}`} />
                  </button>
                  
                  {isSpecsOpen && <motion.div initial={{
                  height: 0,
                  opacity: 0
                }} animate={{
                  height: "auto",
            ...
            <TabsContent value="reviews" className="p-6 bg-white rounded-b-lg shadow-sm">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {[...Array(3)].map((_, i) => <div key={i} className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-gray-700">
                        {["منتج رائع جداً، أنا سعيد جداً بالشراء. الجودة ممتازة والتوصيل كان سريع.", "تجربة شراء ممتازة، المنتج كما هو موصوف تماماً. أنصح به بشدة.", "منتج ممتاز بجودة عالية ويستحق السعر. سأشتري منه مرة أخرى بالتأكيد."][i]}
                      </p>
                    </div>)}
                </div>
            ...
            <TabsContent value="faq" className="p-6 bg-white rounded-b-lg shadow-sm">
              <div className="space-y-4">
                ...
                }].map((item, i) => <div key={i} className="bg-gray-50 p-4 rounded-lg">
